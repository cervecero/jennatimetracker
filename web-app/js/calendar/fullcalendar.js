...
(function($) {
	...
	$.fn.fullCalendar = function(options) {
		...
		this.each(function() {
			...
			monthElement = $("<div id='full_calendar_month' class='full-calendar-month' style='position:relative'/>")
			...
			function render() {
				...
				if (!tbody) {
					...
					glass = $("<div id='calendar_event_interceptor' style='position:absolute;top:0;left:0;z-index:1;width:100%' />")
			...
			function renderEvents() {
                ...
                //TODO: Validate as this is not correctly woring on IE.
                var totalHeight = $("#full_calendar_month").css("height");
                // alert(totalHeight);
                glass.height(totalHeight);
                //$("#calendar_event_interceptor").css("height", monthElement.height());
               // alert("Setting height to interceptor: "+totalHeight+"\nMonth Element Height: "+monthElement.height());
