 ...
 */
class Searchable extends ComposedConfigScript {
    def run() { // normal contents of a config file go in here

        searchable {

            includeScript(customconf.CustomSearchable)
             ...
             */
            compassSettings = [
                    'compass.converter.companyConverter.type': 'CompanyConverter',
                    'compass.converter.companyConverter.registerClass': 'Company',
                    'compass.converter.userConverter.type': 'UserConverter',
                    'compass.converter.userConverter.registerClass': 'User'
            ]
