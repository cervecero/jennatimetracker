...
<head profile="http://gmpg.org/xfn/11">
    ...
    <link rel="stylesheet" type="text/css" href="${resource(dir:'css',file:'jquery-ui-1.8.16.custom.css')}" media="screen">
    <link rel="stylesheet" type="text/css" href="${resource(dir:'css',file:'fg.menu.css')}" media="screen">

  <g:javascript library="application" />
  <g:javascript library="jquery_new" />
  <g:javascript library="jquery_ui_new" />
        ...
        <div id="reports_div" style="float: left;">
          ...
          <div id="reports" class="hidden">
            <ul>
                ...
                <li><a href="${createLink(controller: 'reports', action: 'usersGantt')}" title="Users' assignations "><g:message code="app.menu.administration.reports.usersGantt"/></a>
                </li>
            </ul>
          </div>
        </div>
       ...
       <div id="administration_div" style="float: left;">
        ...
        <ul>
          ...
          <g:ifAnyGranted role="ROLE_COMPANY_ADMIN">
            ...
            <li><a href="${createLink(controller: 'user')}" title="Users"><g:message code="app.menu.administration.users"/></a></li>
